...
public class MissingWordFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        */
        ...
        final String answer = mSlide.ContentEnglish.substring(mSlide.ContentEnglish.indexOf('(') + 1, mSlide.ContentEnglish.lastIndexOf(')'));
        //mTarget = answer;
        final String content = mSlide.ContentEnglish.substring(0, mSlide.ContentEnglish.indexOf('('));
    ...
    public void onResume() {
        ...
        ((MyApplication)getActivity().getApplication()).playAudio(mSentence, mSlide.AudioFileName);
    }

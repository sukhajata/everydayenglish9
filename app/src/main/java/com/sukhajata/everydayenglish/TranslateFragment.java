    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtEnglish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((MyApplication)getActivity().getApplication()).playAudio(mSlide.ContentEnglish, mSlide.AudioFileName);
    ...
    private  void onButtonClicked(FrameLayout frame, SlideMedia word) {
        ...
        if (word.English.toLowerCase().equals(mTarget.English.toLowerCase())) {
            ...
            if (mQueue.isEmpty()) {
                ...
                ((TextView)mLayout.findViewById(R.id.translate_txtEnglish)).setText(mSlide.ContentEnglish);

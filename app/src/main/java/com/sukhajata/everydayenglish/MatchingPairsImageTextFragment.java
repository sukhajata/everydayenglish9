...
import static com.sukhajata.everydayenglish.LessonActivity.ARG_NAME_IMAGE_URL;
import static com.sukhajata.everydayenglish.LessonActivity.ARG_NAME_INSTRUCTIONS;
...
public class MatchingPairsImageTextFragment extends Fragment {
    ...
    public void onTextButtonPressed(Button button, FrameLayout frame) {
        ...
        ((MyApplication)getActivity().getApplication()).playAudio(mSelectedTextPhrase.English, mSelectedTextPhrase.AudioFileName);

...
import com.sukhajata.everydayenglish.ContentManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((MyApplication)getActivity().getApplication()).playAudio(
                        mSlide.MediaList.get(0).English,
                        mSlide.MediaList.get(0).AudioFileName);
            }
        });
        ...
        txt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((MyApplication)getActivity().getApplication()).playAudio(
                        mSlide.MediaList.get(1).English,
                        mSlide.MediaList.get(1).AudioFileName);
            }
        });
        ...
        txt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((MyApplication)getActivity().getApplication()).playAudio(
                        mSlide.MediaList.get(2).English,
                        mSlide.MediaList.get(2).AudioFileName);
            }
        });
        ...
        if (mSlide.MediaList.size() > 3) {
            ...
            txt4.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ((MyApplication)getActivity().getApplication()).playAudio(
                            mSlide.MediaList.get(3).English,
                            mSlide.MediaList.get(3).AudioFileName);
                }
            });
        ...
        if (mSlide.MediaList.size() > 4) {
            ...
            txt5.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ((MyApplication)getActivity().getApplication()).playAudio(
                            mSlide.MediaList.get(4).English,
                            mSlide.MediaList.get(4).AudioFileName);
                }
            });
        ...
        if (mSlide.MediaList.size() > 5) {
            ...
            txt6.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ((MyApplication)getActivity().getApplication()).playAudio(
                            mSlide.MediaList.get(5).English,
                            mSlide.MediaList.get(5).AudioFileName);
                }
            });
        ...
        if (mSlide.MediaList.size() > 6) {
            ...
            txt7.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ((MyApplication)getActivity().getApplication()).playAudio(
                            mSlide.MediaList.get(6).English,
                            mSlide.MediaList.get(6).AudioFileName);
                }
            });
        ...
        if (mSlide.MediaList.size() > 7) {
            ...
            txt8.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ((MyApplication)getActivity().getApplication()).playAudio(
                            mSlide.MediaList.get(7).English,
                            mSlide.MediaList.get(7).AudioFileName);
                }
            });
        ...
        if (mSlide.MediaList.size() > 8) {
            ...
            txt9.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ((MyApplication)getActivity().getApplication()).playAudio(
                            mSlide.MediaList.get(8).English,
                            mSlide.MediaList.get(8).AudioFileName);
                }
            });
        ...
        if (mSlide.MediaList.size() > 9) {
            ...
            txt10.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ((MyApplication)getActivity().getApplication()).playAudio(
                            mSlide.MediaList.get(9).English,
                            mSlide.MediaList.get(9).AudioFileName);
                }
            });

...
public class QuestionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView txtThai = (TextView)view.findViewById(R.id.question_textContentThai);
        txtThai.setText(mPage.ContentThai);

        TextView txtContent = (TextView)view.findViewById(R.id.question_txtContent);
        txtContent.setText(mPage.ContentEnglish);
        txtContent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((MyApplication)getActivity().getApplication()).playAudio(mPage.ContentEnglish, mPage.AudioFileName);
            }
        });
